...
Also, you can visit the page in [zread](https://zread.ai/steineggerlab/foldseek) and [deepwiki](https://deepwiki.com/steineggerlab/foldseek) for more advice.
